/********************
 * links
 * {@link} -  https://uigradients.com/#MoonlitAsteroid
...
function sendNumberValue(number) {
    //replace current display value if first is entered
...
function useOperator(operator) {
    const currentValue = Number(calculatorDisplay.textContent); //convert
...
//add event listeners numbers, operator, decimal buttons
